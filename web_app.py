...
def go_to_broker(broker, stock):
    ...
    if broker == "groww":
        return redirect(f"https://www.google.com/search?q={clean_stock}+stock+groww")

    elif broker == "zerodha":
        return redirect(f"https://kite.zerodha.com/?search={clean_stock}")

    elif broker == "upstox":
        return redirect(f"https://www.google.com/search?q={clean_stock}+stock+upstox")
